...
def get_sign(functionId, body, uuid, client, clientVersion):
    ...
    ep = '{"ciphertype":5,"cipher":{"screen":"CJO3CMeyDJCy","area":"CV8yEJUzXzU0CNG0XzK=","wifiBssid":"DQPrDwHwDWDtDzZtDQOnCWS5YWPwDwY1DzHuYWHvDWG=","osVersion":"CJGkCm==","uuid":"aQf1ZRdxb2r4ovZ1EJZhcxYlVNZSZz09","adid":"EJUyDtHPEJGjHJS5CI00DUZMBUTPCuUjGzu0GJDNGJCmDzO3","openudid":"CtYyENcnZQO5Y2OzYwGnDtVuZtq4CQG5D2VrYJc2Y2ZrYzVuC2Y3Zq=="},"ts":int(time.time()),"hdid":"JM9F1ywUPwflvMIpYPok0tt5k9kW4ArJEU3lfLhxBqw=","version":"1.0.3","appname":"com.360buy.jdmobile","ridx":-1}'
    string = f"functionId={functionId}&body={body}&client={client}&clientVersion={clientVersion}&ep={ep}&ef=1st={st}&sv=1{sv}"
